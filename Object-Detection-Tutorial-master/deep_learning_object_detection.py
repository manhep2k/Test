...
CLASSES = ["background", "aeroplane", "bicycle", "bird", "boat",
	...
	"sofa", "train", "tvmonitor","electric bicycle","cyclo","Phone","tree"]
...
# implementation)
#tải hình ảnh đầu vào và xây dựng một đốm màu đầu vào cho hình ảnh
#bằng cách thay đổi kích thước thành 300x300 pixel cố định và sau đó chuẩn hóa nó
#(lưu ý: quá trình chuẩn hóa được thực hiện thông qua các tác giả của MobileNet SSD thực hiện
...
# python deep_learning_object_detection.py --image images/ptgiaothong.jpg --prototxt MobileNetSSD_deploy.prototxt.txt --model MobileNetSSD_deploy.caffemodel

# python deep_learning_object_detection.py --image images/ngua.jfif --prototxt MobileNetSSD_deploy.prototxt.txt --model MobileNetSSD_deploy.caffemodel
