...
{
    public partial class doitac : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CtrCongNoID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    CtrHopDongID = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CtrDoiTacID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    MaSoThue = table.Column<int>(type: "int", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CtrKhachHangID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CtrKhachHangID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TrangThai = table.Column<bool>(type: "bit", nullable: false),
                    CtrCongNoID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "CtrDoiTac",
                columns: new[] { "CtrDoiTacID", "DiaChi", "DienThoai", "MaDoitac", "MaSoThue", "TaiKhoanDangNhap", "TenDoiTac" },
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), "phạm văn mạnh", 1555555, "01", 777, "ADMIN", "phạm văn mạnh" });

            migrationBuilder.InsertData(
                table: "CtrDoiTac",
                columns: new[] { "CtrDoiTacID", "DiaChi", "DienThoai", "MaDoitac", "MaSoThue", "TaiKhoanDangNhap", "TenDoiTac" },
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "phạm văn mạnh", 1555555, "02", 777, "ADMIN", "phạm văn mạnh" });
